...
*/
  ...
  NewNews(itemData): Observable<any> {
    return this._httpClient.post(environment.API_URL + 'api/event_land', itemData, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        return of(response);
      })
    );
  ...
  getNewsPage(dataTablesParameters: any): Observable<DataTablesResponse> {
    return this._httpClient.post(environment.API_URL + 'api/event_land_page', dataTablesParameters, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
  ...
  updateItem(itemData: FormData): Observable<any> {
    return this._httpClient.post(environment.API_URL + 'api/update_land', itemData, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        return of(response);
      })
    );
