...
*/
  ...
  createVendor(vendor: any): Observable<any> {
    ...
    //     return throwError('User is already logged in.');
    // }
    return this._httpClient.post(environment.API_URL + 'api/vendor', vendor, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  getVendor(): Observable<any> {
    return this._httpClient.get<any>(environment.API_URL + 'api/get_vendor')
  }

  //   * get branch by id
  getVendorById(vendorId: string): Observable<any[]> {
    return this._httpClient.get<any[]>(environment.API_URL + 'api/vendor/' + vendorId).pipe(
      tap((meterial) => {
        this._materials.next(meterial);
      })
    );
  ...
  //   * update branch
  updateVendor(vendor: any, vendorId): Observable<any> {
    return this._httpClient.put(environment.API_URL + 'api/vendor/' + vendorId, vendor, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  getVendorPage(dataTablesParameters: any): Observable<DataTablesResponse> {
    return this._httpClient.post(environment.API_URL + 'api/vendor_page', dataTablesParameters, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
