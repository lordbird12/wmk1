...
import { AssetType, BranchPagination, DataItemType } from '../item-type.types';
...
export class ItemTypeListComponent implements OnInit, AfterViewInit, OnDestroy {

    dtOptions: DataTables.Settings = {};
    dataRow: any[] = [];
    @ViewChild(MatPaginator) _paginator: MatPaginator;
    @ViewChild(MatSort) private _sort: MatSort;
    displayedColumns: string[] = ['id', 'name', 'initial', 'status', 'create_by', 'created_at', 'actions'];
    dataSource: MatTableDataSource<DataItemType>;
    ...
    edit(itemtypeId: string): void {
        this._router.navigate(['item-type/edit/' + itemtypeId]);
    }
