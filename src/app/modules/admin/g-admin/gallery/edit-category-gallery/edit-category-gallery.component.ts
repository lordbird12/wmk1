...
@Component({
    selector: 'edit-category-gallery',
    templateUrl: './edit-category-gallery.component.html',
    styleUrls: ['./edit-category-gallery.component.scss'],
    animations: fuseAnimations
})

export class EditCategoryGalleryComponent implements OnInit, AfterViewInit, OnDestroy {
