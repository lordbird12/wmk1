...
@Component({
    selector: 'new-gallery',
    templateUrl: './new-gallery.component.html',
    styleUrls: ['./new-gallery.component.scss'],
    animations: fuseAnimations
})

export class NewGalleryComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    CreateItem(): void {
        ...
        const confirmation = this._fuseConfirmationService.open({
            ...
            "message": "คุณต้องการเพิ่มแกลลอรี่ใช่หรือไม่ ",
            "icon": {
                "show": false,
        ...
        confirmation.afterClosed().subscribe((result) => {
            ...
            if (result === 'confirmed') {
                ...
                this._Service.NewNews(formData).subscribe(
                    {
                        next: (resp: any) => {
                            this._router.navigateByUrl('gallery/list').then(() => { })
                        },
                        error: (err: any) => {
