...
import { AssetType, CustomerPagination } from '../gallery.types';
...
export class EditGalleryComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    async ngOnInit(): Promise<void> {
        ...
        this.formData.patchValue({
            id: this.itemId,
            category_gallerie_id: +this.dataRow.category_gallerie_id ?? '',
            title: this.dataRow.title ?? '',
            shot_detail: this.dataRow.shot_detail ?? '',
    ...
    updateItem(): void {
        ...
        const confirmation = this._fuseConfirmationService.open({
            ...
            "message": "คุณต้องการแก้ไขข้อมูลข่าวใช่หรือไม่ ",
            "icon": {
                "show": false,
