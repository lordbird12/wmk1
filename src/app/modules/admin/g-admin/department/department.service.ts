...
import {
  ...
  DepartmentPagination, DepartmentProduct, StoreType, AssetSize, Supplier, Division, DepartmentPage
...
export class DepartmentService {
  // Private
  private _pagination: BehaviorSubject<DepartmentPagination | null> = new BehaviorSubject(null);
  private _product: BehaviorSubject<DepartmentProduct | null> = new BehaviorSubject(null);
  private _products: BehaviorSubject<DepartmentProduct[] | null> = new BehaviorSubject(null);
  private _product_osm: BehaviorSubject<DepartmentProduct | null> = new BehaviorSubject(null);
  private _products_osm: BehaviorSubject<DepartmentProduct[] | null> = new BehaviorSubject(null);
   ...
   */
  get pagination$(): Observable<DepartmentPagination> {
   ...
   * Getter for product
   */
  get product$(): Observable<DepartmentProduct> {
   ...
   * Getter for products
   */
  get products$(): Observable<DepartmentProduct[]> {
   ...
   * Getter for product
   */
  get product_osm$(): Observable<DepartmentProduct> {
...
*/
  ...
  getProducts(page: number = 0,
    ...
    Observable<{ meta: DepartmentPagination; data: DepartmentProduct[] }> {
    ...
    return this._httpClient.get<{ meta: DepartmentPagination; data: DepartmentProduct[] }>(environment.API_URL + 'api/briefs', {
  ...
  getProductsND(page: number = 0,
    ...
    return this._httpClient.get<{ meta: DepartmentPagination; data: DepartmentProduct[] }>(environment.API_URL + 'api/brief-osms', {
      params: searchParams, headers: new HttpHeaders({ Authorization: `Bearer ${token}` })
    }).pipe(
      tap((response) => {
        this._pagination.next({
  ...
  */
   ...
   * Create product
   */
  createProduct(): Observable<DepartmentProduct> {
    return this.products$.pipe(
      take(1),
      switchMap(products => this._httpClient.post<DepartmentProduct>('api/marketing/brief-plan/product', {}).pipe(
        map((newProduct) => {
   ...
   * @param product
   */
  updateProduct(id: string, product: DepartmentProduct): Observable<DepartmentProduct> {
    return this.products$.pipe(
      take(1),
      switchMap(products => this._httpClient.patch<DepartmentProduct>('api/marketing/brief-plan/product', {
        id,
        product
      }).pipe(
        map((updatedProduct) => {
...
*/
  ...
  createDepartment(department: any): Observable<any> {
    return this._httpClient.post(environment.API_URL + 'api/department', department, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  getDataTableDepartment(department: DepartmentPage): Observable<any> {
    return this._httpClient.post(environment.API_URL + 'api/department_page', department, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  getDepartment(): Observable<any> {
    return this._httpClient.get<any>(environment.API_URL + 'api/get_department').pipe(
      tap((meterial) => {
        this._materials.next(meterial);
      })
    );
  ...
  getDepartmentById(departmentId: any): Observable<any> {
    return this._httpClient.get<any>(environment.API_URL + 'api/department/' + departmentId).pipe(
      tap((meterial) => {
        this._materials.next(meterial);
      })
    );
  ...
  //   * update branch
  updateDepartment(department: any, departmentId): Observable<any> {
    return this._httpClient.put(environment.API_URL + 'api/department/' + departmentId, department, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  getDepartmentPage(dataTablesParameters: any): Observable<DataTablesResponse> {
    return this._httpClient.post(environment.API_URL + 'api/department_page', dataTablesParameters, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
