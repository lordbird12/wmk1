...
export class EditWarehouseComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this._Service.getWarehouseById(this.warehouseId).subscribe((resp: any) => {
    ...
    UpdateWarehouse(): void {
        ...
        confirmation.afterClosed().subscribe((result) => {
            ...
            if (result === 'confirmed') {
                ...
                this._Service.updateWarehouse(this.formData.value, this.warehouseId).subscribe(
                    {
                        next: (resp: any) => {
                            this._router.navigateByUrl('warehouse/list').then(() => { })
                        },
                        error: (err: any) => {
