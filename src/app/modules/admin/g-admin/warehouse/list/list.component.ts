...
import { AssetType, BranchPagination, DataWarehouse } from '../warehouse.types';
...
export class WarehouseListComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    edit(warehouseId: string): void {
        this._router.navigate(['warehouse/edit/' + warehouseId]);
    }
