...
import { depositRoute } from './group-monk.routing';
...
@NgModule({
  declarations: [
    GroupMonkComponent,
    NewGroupMonkComponent,
    GroupMonkListComponent,
    ModalMonk,
    EditGroupMonkComponent,
    NewMonkGroupComponent
  ],
  imports: [
