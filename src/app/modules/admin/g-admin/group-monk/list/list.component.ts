...
import { AssetType, CustomerPagination, DataCustomer } from '../group-monk.types';
...
export class GroupMonkListComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    loadTable(): void {
        ...
        this.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                ...
                that._Service.getGroupPage(dataTablesParameters).subscribe((resp) => {
                    this.dataRow = resp.data
                    console.log(resp)
    ...
    edit(customerId: string): void {
        this._router.navigate(['/group-monk/edit/' + customerId]);
    }
