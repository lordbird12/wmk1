...
export class SalaListComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    loadTable(): void {
        ...
        this.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                ...
                that._Service.getSalaPage(dataTablesParameters).subscribe((resp) => {
                    this.dataRow = resp.data
                    console.log(resp)
    ...
    edit(customerId: string): void {
        this._router.navigate(['/sala/edit/' + customerId]);
    }
