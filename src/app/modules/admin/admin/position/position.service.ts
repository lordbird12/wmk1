...
*/
  ...
  updatePosition(position: any, positionId): Observable<any> {
    return this._httpClient.put(environment.API_URL + 'api/position/' + positionId, position, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  getPositionPage(dataTablesParameters: any): Observable<DataTablesResponse> {
    return this._httpClient.post(environment.API_URL + 'api/position_page', dataTablesParameters, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
