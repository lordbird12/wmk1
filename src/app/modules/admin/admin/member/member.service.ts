...
*/
  ...
  getMemberById(customerId: any): Observable<any> {
    return this._httpClient.get<any>(environment.API_URL + 'api/member/' + customerId).pipe(
      tap((meterial) => {
        this._materials.next(meterial);
      })
    );
  ...
  updateMember(member: any, memberId: string): Observable<any> {
    return this._httpClient.put(environment.API_URL + 'api/member/' + memberId, member).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  getMemberPage(dataTablesParameters: any): Observable<DataTablesResponse> {
    return this._httpClient.post(environment.API_URL + 'api/member_page', dataTablesParameters).pipe(
      switchMap((response: any) => {
