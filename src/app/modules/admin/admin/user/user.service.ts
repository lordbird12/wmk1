...
*/
    ...
    getUserprofile(): Observable<any[]> {
        return this._httpClient.get<any[]>(environment.API_URL + 'api/user_profile')
            .pipe(
                tap((user) => {
    ...
    // getUserprofile(): Observable<any> {
    //     return this._httpClient
    //       .get<any>(environment.API_URL +'api/user_profile' )
    //       .pipe(catchError(this.handlerError));
    //   }
    ...
    changepassword(password: any, userId): Observable<any> {
        return this._httpClient.put(environment.API_URL + 'api/reset_password_user/' + userId, password).pipe(
            switchMap((response: any) => {
                // Return a new observable with the response
                return of(response);
            })
