...
*/
  ...
  createItemType(itemtype: any): Observable<any> {
    ...
    //     return throwError('User is already logged in.');
    // }
    return this._httpClient.post(environment.API_URL + 'api/item_type', itemtype).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  updateItemType(itemtype: any, itemtypeId): Observable<any> {
    return this._httpClient.put(environment.API_URL + 'api/item_type/' + itemtypeId, itemtype).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  getItemTypePage(dataTablesParameters: any): Observable<DataTablesResponse> {
    return this._httpClient.post(environment.API_URL + 'api/item_type_page', dataTablesParameters).pipe(
      switchMap((response: any) => {
