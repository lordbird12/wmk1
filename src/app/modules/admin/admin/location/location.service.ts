...
*/
  ...
  createLocation(location: FormData): Observable<any> {
    ...
    //     return throwError('User is already logged in.');
    // }
    return this._httpClient.post(environment.API_URL + 'api/location', location).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  updateLocation(location: any, locationId): Observable<any> {
    return this._httpClient.put(environment.API_URL + 'api/location/' + locationId, location).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  getLocationPage(dataTablesParameters: any): Observable<DataTablesResponse> {
    return this._httpClient.post(environment.API_URL + 'api/location_page', dataTablesParameters).pipe(
      switchMap((response: any) => {
