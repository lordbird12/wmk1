...
*/
  ...
  createLocation(location: FormData): Observable<any> {
    ...
    //     return throwError('User is already logged in.');
    // }
    return this._httpClient.post(environment.API_URL + 'api/location', location, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  getLocation(): Observable<any> {
    return this._httpClient.get<any>(environment.API_URL + 'api/get_location')
  }

  //   * get branch by id
  getLocationById(locationId: string): Observable<any> {
    return this._httpClient.get<any>(environment.API_URL + 'api/location/' + locationId).pipe(
      tap((meterial) => {
        this._materials.next(meterial);
      })
    );
  ...
  //   * update branch
  updateLocation(location: any, locationId): Observable<any> {
    return this._httpClient.put(environment.API_URL + 'api/location/' + locationId, location, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  getLocationPage(dataTablesParameters: any): Observable<DataTablesResponse> {
    return this._httpClient.post(environment.API_URL + 'api/location_page', dataTablesParameters, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
