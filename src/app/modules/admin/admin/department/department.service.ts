...
*/
  ...
  createDepartment(department: any): Observable<any> {
    return this._httpClient.post(environment.API_URL + 'api/department', department).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  getDataTableDepartment(department: DepartmentPage): Observable<any> {
    return this._httpClient.post(environment.API_URL + 'api/department_page', department).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  updateDepartment(department: any, departmentId): Observable<any> {
    return this._httpClient.put(environment.API_URL + 'api/department/' + departmentId, department).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  getDepartmentPage(dataTablesParameters: any): Observable<DataTablesResponse> {
    return this._httpClient.post(environment.API_URL + 'api/department_page', dataTablesParameters).pipe(
      switchMap((response: any) => {
