...
*/
  ...
  NewNews(itemData: FormData): Observable<any> {
    return this._httpClient.post(environment.API_URL + 'api/news', itemData).pipe(
      switchMap((response: any) => {
        return of(response);
      })
    );
  ...
  NewCategory(itemData): Observable<any> {
    return this._httpClient.post(environment.API_URL + 'api/category_news', itemData).pipe(
      switchMap((response: any) => {
        return of(response);
      })
    );
  ...
  getNewsPage(dataTablesParameters: any): Observable<DataTablesResponse> {
    return this._httpClient.post(environment.API_URL + 'api/news_page', dataTablesParameters).pipe(
      switchMap((response: any) => {
  ...
  getCategoryPage(dataTablesParameters: any): Observable<DataTablesResponse> {
    return this._httpClient.post(environment.API_URL + 'api/category_news_page', dataTablesParameters).pipe(
      switchMap((response: any) => {
        return of(response.data);
      })
    );
  ...
  getNewsById(itemId: any): Observable<any> {
    return this._httpClient.get<any>(environment.API_URL + 'api/news/' + itemId).pipe(
      tap((meterial) => {
        this._materials.next(meterial);
      })
    );
  ...
  getCategory(): Observable<any> {
    return this._httpClient.get<any>(environment.API_URL + 'api/get_category_news').pipe(
      tap((meterial) => {
        this._materials.next(meterial);
      })
    );
  ...
  updateItem(itemData: FormData): Observable<any> {
    return this._httpClient.post(environment.API_URL + 'api/update_news', itemData).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
