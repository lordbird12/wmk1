...
*/
  ...
  NewNews(itemData: FormData): Observable<any> {
    return this._httpClient.post(environment.API_URL + 'api/news', itemData, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        return of(response);
      })
    );
  ...
  NewCategory(itemData): Observable<any> {
    return this._httpClient.post(environment.API_URL + 'api/category_news', itemData, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        return of(response);
      })
    );
  ...
  getCategoryPage(dataTablesParameters: any): Observable<DataTablesResponse> {
    return this._httpClient.post(environment.API_URL + 'api/category_news_page', dataTablesParameters, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        return of(response.data);
      })
    );
  ...
  updateItem(itemData: FormData): Observable<any> {
    return this._httpClient.post(environment.API_URL + 'api/update_news', itemData, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
