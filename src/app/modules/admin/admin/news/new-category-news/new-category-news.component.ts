...
@Component({
    selector: 'new-category-news',
    templateUrl: './new-category-news.component.html',
    styleUrls: ['./new-category-news.component.scss'],
    animations: fuseAnimations
})

export class NewCategoryNewsComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    New(): void {
        ...
        const confirmation = this._fuseConfirmationService.open({
            ...
            "message": "คุณต้องการเพิ่มหมวดหมู่ข่าวใหม่ใช่หรือไม่ ",
            "icon": {
                "show": false,
        ...
        confirmation.afterClosed().subscribe((result) => {
            ...
            if (result === 'confirmed') {
                ...
                this._Service.NewCategory(formValue).subscribe(
                    {
                        next: (resp: any) => {
                            this._router.navigateByUrl('news/list-category-news').then(() => { })
                        },
                        error: (err: any) => {
