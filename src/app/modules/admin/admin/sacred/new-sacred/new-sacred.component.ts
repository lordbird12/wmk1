...
@Component({
    selector: 'new-sacred',
    templateUrl: './new-sacred.component.html',
    styleUrls: ['./new-sacred.component.scss'],
...
export class NewComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    CreateItem(): void {
        ...
        const confirmation = this._fuseConfirmationService.open({
            "title": "เพิ่มวัตถุมงคลใหม่",
            "message": "คุณต้องการเพิ่มวัตถุมงคลใช่หรือไม่ ",
            "icon": {
                "show": false,
        ...
        confirmation.afterClosed().subscribe((result) => {
            ...
            if (result === 'confirmed') {
                ...
                this._Service.NewNews(formData).subscribe(
                    {
                        next: (resp: any) => {
                            this._router.navigateByUrl('sacred/list').then(() => { })
                        },
                        error: (err: any) => {
