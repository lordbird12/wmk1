...
*/
  ...
  getProducts(page: number = 0,
    ...
    Observable<{ meta: CustomerPagination; data: CustomerProduct[] }> {
    ...
    return this._httpClient.get<{ meta: CustomerPagination; data: CustomerProduct[] }>(environment.API_URL + 'api/briefs', {
  ...
  getProductsND(page: number = 0,
    ...
    return this._httpClient.get<{ meta: CustomerPagination; data: CustomerProduct[] }>(environment.API_URL + 'api/brief-osms', {
      params: searchParams, headers: new HttpHeaders({ Authorization: `Bearer ${token}` })
    }).pipe(
      tap((response) => {
        this._pagination.next({
  ...
  */
   ...
   * Create product
   */
  createProduct(): Observable<CustomerProduct> {
    return this.products$.pipe(
      take(1),
      switchMap(products => this._httpClient.post<CustomerProduct>('api/marketing/brief-plan/product', {}).pipe(
        map((newProduct) => {
   ...
   * @param product
   */
  updateProduct(id: string, product: CustomerProduct): Observable<CustomerProduct> {
    return this.products$.pipe(
      take(1),
      switchMap(products => this._httpClient.patch<CustomerProduct>('api/marketing/brief-plan/product', {
        id,
        product
      }).pipe(
        map((updatedProduct) => {
...
*/
  ...
  createItem(itemData: FormData): Observable<any> {
    return this._httpClient.post(environment.API_URL + 'api/item', itemData).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      }),
  ...
  NewNews(itemData): Observable<any> {
    return this._httpClient.post(environment.API_URL + 'api/rent_land', itemData).pipe(
      switchMap((response: any) => {
        return of(response);
      })
    );
  ...
  NewCategory(itemData): Observable<any> {
    return this._httpClient.post(environment.API_URL + 'api/category_gallery', itemData).pipe(
      switchMap((response: any) => {
        return of(response);
      })
    );
  ...
  getNewsPage(dataTablesParameters: any): Observable<DataTablesResponse> {
    return this._httpClient.post(environment.API_URL + 'api/rent_land_page', dataTablesParameters).pipe(
      switchMap((response: any) => {
  ...
  getCategoryPage(dataTablesParameters: any): Observable<DataTablesResponse> {
    return this._httpClient.post(environment.API_URL + 'api/category_gallery_page', dataTablesParameters).pipe(
      switchMap((response: any) => {
        return of(response.data);
      })
    );
  ...
  getNewsById(itemId: any): Observable<any> {
    return this._httpClient.get<any>(environment.API_URL + 'api/rent_land/' + itemId).pipe(
      tap((meterial) => {
        this._materials.next(meterial);
      })
    );
  ...
  getCategorykById(itemId: any): Observable<any> {
    return this._httpClient.get<any>(environment.API_URL + 'api/category_news/' + itemId).pipe(
      tap((meterial) => {
        this._materials.next(meterial);
      })
    );
  ...
  getLand(): Observable<any> {
    return this._httpClient.get<any>(environment.API_URL + 'api/get_land').pipe(
      tap((meterial) => {
        this._materials.next(meterial);
      })
    );
  ...
  getEventLand(): Observable<any> {
    return this._httpClient.get<any>(environment.API_URL + 'api/get_event_land').pipe(
      tap((meterial) => {
        this._materials.next(meterial);
      })
    );
  ...
  updateItem(itemData, itmeId: string): Observable<any> {
    return this._httpClient.put(environment.API_URL + 'api/rent_land/' + itmeId, itemData).pipe(
      switchMap((response: any) => {
        return of(response);
      })
    );
  ...
  updateCategory(itemData, itemId: string): Observable<any> {
    return this._httpClient.put(environment.API_URL + 'api/category_news/' + itemId, itemData).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  getByItemType(itemTypeId: number): Observable<any> {
    return this._httpClient.post(environment.API_URL + 'api/get_item', { item_type_id: itemTypeId }).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  uploadImg(img: FormData): Observable<any> {
    return this._httpClient.post(environment.API_URL + 'api/upload_images', img).pipe(
      switchMap((response: any) => {
        return of(response.data);
      })
    );
