    ...
    ngOnInit(): void {
        ...
        this._Service.getById(this.id).subscribe((resp: any) => {
            ...
            this.formData.patchValue({
                id: this.itemData.id,
                top_text: this.itemData.top_text,
                big_text: this.itemData.big_text,
                small_text: this.itemData.small_text,
                button_text: this.itemData.button_text,
                button_url: this.itemData.button_url,
                image: ''
            });
        });
    }
        ...
        confirmation.afterClosed().subscribe((result) => {
            ...
            if (result === 'confirmed') {
                ...
                this._Service.update(formData).subscribe({
                    next: (resp: any) => {
                        this._router.navigateByUrl('banner/list').then(() => {});
                    },
                    error: (err: any) => {
