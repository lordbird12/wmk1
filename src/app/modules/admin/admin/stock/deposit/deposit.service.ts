...
*/
  ...
  getItem(): Observable<any> {
    return this._httpClient.get(environment.API_URL + 'api/get_item').pipe(
      switchMap((response: any) => {
        return of(response);
      })
    );
  ...
  updateItem(itemData: FormData): Observable<any> {
    return this._httpClient.post(environment.API_URL + 'api/update_item', itemData).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  getDetepositPage(dataTablesParameters: any): Observable<DataTablesResponse> {
    return this._httpClient.post(environment.API_URL + 'api/withdraw_item_page', dataTablesParameters).pipe(
      switchMap((response: any) => {
  ...
  NewDeposit(itemData): Observable<any> {
    return this._httpClient.post(environment.API_URL + 'api/withdraw_item', itemData).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  newMember(Member: any): Observable<any> {
    return this._httpClient.post(environment.API_URL + 'api/member', Member).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  updateWithdraw(member: any, memberId: string): Observable<any> {
    return this._httpClient.put(environment.API_URL + 'api/withdraw_item/' + memberId, member).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
