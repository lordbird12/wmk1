...
*/
  ...
  getItem(): Observable<any> {
    return this._httpClient.get(environment.API_URL + 'api/get_item', this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        return of(response);
      })
    );
  }
  getMemberById(itemId: any): Observable<any> {
    return this._httpClient.get<any>(environment.API_URL + 'api/member/' + itemId).pipe(
      tap((meterial) => {
        this._materials.next(meterial);
      })
    );
  }
  getWithdrowById(itemId: any): Observable<any> {
    return this._httpClient.get<any>(environment.API_URL + 'api/withdraw_item/' + itemId).pipe(
      tap((meterial) => {
        this._materials.next(meterial);
      })
    );
  ...
  getItemById(itemId: any): Observable<any[]> {
    return this._httpClient.get<any[]>(environment.API_URL + 'api/item/' + itemId).pipe(
      tap((meterial) => {
        this._materials.next(meterial);
      })
    );
  ...
  updateItem(itemData: FormData): Observable<any> {
    return this._httpClient.post(environment.API_URL + 'api/update_item', itemData, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  getDetepositPage(dataTablesParameters: any): Observable<DataTablesResponse> {
    return this._httpClient.post(environment.API_URL + 'api/withdraw_item_page', dataTablesParameters, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
  ...
  NewDeposit(itemData): Observable<any> {
    return this._httpClient.post(environment.API_URL + 'api/withdraw_item', itemData, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  newMember(Member: any): Observable<any> {
    return this._httpClient.post(environment.API_URL + 'api/member', Member, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  updateWithdraw(member: any, memberId: string): Observable<any> {
    return this._httpClient.put(environment.API_URL + 'api/withdraw_item/' + memberId, member, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
