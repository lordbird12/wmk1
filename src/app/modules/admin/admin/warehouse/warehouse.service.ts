...
*/
  ...
  createWarehouse(warehouse: any): Observable<any> {
    ...
    //     return throwError('User is already logged in.');
    // }
    return this._httpClient.post(environment.API_URL + 'api/warehouse', warehouse).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  updateWarehouse(warehouse: any, warehouseId): Observable<any> {
    return this._httpClient.put(environment.API_URL + 'api/warehouse/' + warehouseId, warehouse).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  getWarehousePage(dataTablesParameters: any): Observable<DataTablesResponse> {
    return this._httpClient.post(environment.API_URL + 'api/warehouse_page', dataTablesParameters).pipe(
      switchMap((response: any) => {
