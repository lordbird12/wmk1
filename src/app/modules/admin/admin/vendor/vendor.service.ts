...
*/
  ...
  createVendor(vendor: any): Observable<any> {
    ...
    //     return throwError('User is already logged in.');
    // }
    return this._httpClient.post(environment.API_URL + 'api/vendor', vendor).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  updateVendor(vendor: any, vendorId): Observable<any> {
    return this._httpClient.put(environment.API_URL + 'api/vendor/' + vendorId, vendor).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  getVendorPage(dataTablesParameters: any): Observable<DataTablesResponse> {
    return this._httpClient.post(environment.API_URL + 'api/vendor_page', dataTablesParameters).pipe(
      switchMap((response: any) => {
