...
export class EditVendorComponent implements OnInit, AfterViewInit, OnDestroy {
     ...
     */
    ngOnInit(): void {
        this.vendorId = this._activatedRoute.snapshot.paramMap.get('id');
        this._Service.getVendorById(this.vendorId).subscribe((resp: any) => {
    ...
    UpdateVendor(): void {
        ...
        const confirmation = this._fuseConfirmationService.open({
            ...
            "message": "คุณต้องการแก้ไขซัพพลายเออร์ใช่หรือไม่ ",
            "icon": {
                "show": false,
        ...
        confirmation.afterClosed().subscribe((result) => {
            ...
            if (result === 'confirmed') {
                ...
                this._Service.updateVendor(this.formData.value, this.vendorId).subscribe((res: any) => {
