...
export class MonkListComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                that._Service.getMonkPage(dataTablesParameters).subscribe((resp) => {
    ...
    edit(customerId: string): void {
        this._router.navigate(['/monk/edit/' + customerId]);
    }
