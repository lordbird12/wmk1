...
import { Item } from '../event-land.types';
import { EventLandService } from '../event-land.service';
import { PictureComponent } from 'app/modules/admin/admin/bank/picture/picture.component';

@Component({
    selector: 'event-land-list',
...
export class ListComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                that._Service.getNewsPage(dataTablesParameters).subscribe((resp) => {
    ...
    edit(customerId: string): void {
        this._router.navigate(['/event-land/edit/' + customerId]);
    }
    new(): void {
        this._router.navigate(['/event-land/new']);
    }
