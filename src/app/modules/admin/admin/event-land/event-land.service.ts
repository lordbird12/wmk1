...
*/
  ...
  NewNews(itemData): Observable<any> {
    return this._httpClient.post(environment.API_URL + 'api/event_land', itemData).pipe(
      switchMap((response: any) => {
        return of(response);
      })
    );
  ...
  getNewsPage(dataTablesParameters: any): Observable<DataTablesResponse> {
    return this._httpClient.post(environment.API_URL + 'api/event_land_page', dataTablesParameters).pipe(
      switchMap((response: any) => {
  ...
  getNewsById(itemId: any): Observable<any> {
    return this._httpClient.get<any>(environment.API_URL + 'api/event_land/' + itemId).pipe(
      tap((meterial) => {
        this._materials.next(meterial);
      })
    );
  ...
  updateItem(itemData: FormData): Observable<any> {
    return this._httpClient.post(environment.API_URL + 'api/update_land', itemData).pipe(
      switchMap((response: any) => {
        return of(response);
      })
    );
