...
export class Service {
    ...
    getList(): Observable<any> {
        return this._httpClient
            .get<any>(environment.API_URL + '/api/get_review')
            .pipe(
                tap((meterial) => {
                    this._materials.next(meterial);
                })
    ...
    getById(id: any): Observable<any[]> {
        return this._httpClient
            .get<any[]>(environment.API_URL + '/api/review/' + id)
            .pipe(
                tap((meterial) => {
                    this._materials.next(meterial);
                })
    ...
    update(data: any): Observable<any> {
        return this._httpClient
            .post(
                environment.API_URL + '/api/update_review',
                data,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    getPage(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient.post(environment.API_URL + '/api/review_page', dataTablesParameters).pipe(
            switchMap((response: any) => {
