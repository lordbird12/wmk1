...
export class Service {
    ...
    getCategory(): Observable<any> {
        return this._httpClient.get(environment.API_URL + '/api/get_product_category').pipe(
            switchMap((response: any) => {
                return of(response);
            })
        );
    ...
    getById(id: any): Observable<any[]> {
        return this._httpClient
            .get<any[]>(environment.API_URL + '/api/main_product/' + id)
            .pipe(
                tap((meterial) => {
                    this._materials.next(meterial);
                })
    ...
    update(data: any): Observable<any> {
        return this._httpClient
            .post(
                environment.API_URL + '/api/update_main_product',
                data,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    getPage(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient.post(environment.API_URL + '/api/main_product_page', dataTablesParameters).pipe(
            switchMap((response: any) => {
