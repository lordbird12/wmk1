...
export class Service {
    ...
    create(data: any): Observable<any> {
        return this._httpClient
            .post(
                environment.API_URL + '/api/product_category',
                data,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    getList(): Observable<any> {
        return this._httpClient
            .get<any>(environment.API_URL + 'api/get_product_category')
            .pipe(
                tap((meterial) => {
                    this._materials.next(meterial);
                })
    ...
    delete(id: any): Observable<any> {
        return this._httpClient.delete<any>(
            environment.API_URL + '/api/product_category/' + id,
            { headers: this.httpOptionsFormdata.headers }
        );
    }
    ...
    getById(id: any): Observable<any[]> {
        return this._httpClient
            .get<any[]>(environment.API_URL + '/api/product_category/' + id)
            .pipe(
                tap((meterial) => {
                    this._materials.next(meterial);
                })
    ...
    update(data: any): Observable<any> {
        return this._httpClient
            .post(
                environment.API_URL + '/api/update_product_category',
                data,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    getPage(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient.post(environment.API_URL + '/api/product_category_page', dataTablesParameters).pipe(
            switchMap((response: any) => {
