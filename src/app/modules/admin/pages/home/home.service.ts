...
*/
  ...
  createBranch(branch: any): Observable<any> {
    ...
    //     return throwError('User is already logged in.');
    // }
    return this._httpClient.post(environment.API_URL + 'api/branch', branch).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  getAll(dataTablesParameters: any): Observable<any> {
    return this._httpClient
      .post<any>(`${environment.API_URL}api/branch_page`, dataTablesParameters)
      .pipe(
        map((resp: any) => {
          return resp;
        }));
  ...
  updateBranch(branch: any, branchId): Observable<any> {
    return this._httpClient.put(environment.API_URL + 'api/branch/' + branchId, branch).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  getBranchPage(dataTablesParameters: any): Observable<DataTablesResponse> {
    return this._httpClient.post(environment.API_URL + 'api/branch_page', dataTablesParameters).pipe(
      switchMap((response: any) => {
